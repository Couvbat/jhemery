...
const body: Localised<string[]> = {
  en: [
    ...
    '',
    'So: if you want to talk shop with someone who reads the whole manual,',
  ...
  fr: [
    ...
    '',
    'Alors : si vous voulez parler technique avec quelqu\'un qui lit le manuel',
    'en entier, vous savez déjà comment me joindre.',
    '',
